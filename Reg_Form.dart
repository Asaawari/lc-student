...
import 'reg_form_model.dart';
export 'reg_form_model.dart';

class RegFormWidget extends StatefulWidget {
  const RegFormWidget({super.key});

  static String routeName = 'Reg_Form';
  static String routePath = '/regForm';
...
class _RegFormWidgetState extends State<RegFormWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegFormModel());
