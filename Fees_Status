...
import 'fees_status_model.dart';
export 'fees_status_model.dart';

class FeesStatusWidget extends StatefulWidget {
  const FeesStatusWidget({super.key});

  static String routeName = 'Fees_Status';
  static String routePath = '/feesStatus';

  @override
  State<FeesStatusWidget> createState() => _FeesStatusWidgetState();
}

class _FeesStatusWidgetState extends State<FeesStatusWidget> {
  late FeesStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeesStatusModel());
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              'Payment Details Session: 20XX - 20XX',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
